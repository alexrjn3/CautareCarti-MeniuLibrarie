...
public class Meniu {
	...
	//v2 se va folosi pt cautareFisierTextSortat.v pentru CautareFisierText. Daca fol. doar vectorul v il vom modifica in metoda cautareFisierTextSortat(). Daca apelam din nou metoda cautareFisierText nu va mai fi o cautare liniara a text nostru ci
	//cautare liniara a textului nostru sortat.
